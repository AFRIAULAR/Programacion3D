...
/// Agrega m�s tipos seg�n lo necesites.
/// </summary>
...
/// Cada objeto tiene una cantidad inicial, un prefab y la opci�n de expandirse.
/// </summary>
[System.Serializable]
public class ObjectPoolItem
{
    public GameObject objectToPool; // Prefab del objeto que ser� pooleado.
    public int amountToPool; // Cantidad inicial de objetos en el pool.
    public bool shouldExpand; // Si es true, el pool se expande si no hay m�s disponibles.
...
{
    public static ObjectPooler SharedInstance; // Instancia �nica para acceder f�cilmente.
    ...
    /// <summary>
    /// Se ejecuta antes que Start, asegurando que SharedInstance est� disponible desde el inicio.
    /// </summary>
    void Awake()
    {
        SharedInstance = this;
    ...
    /// <summary>
    /// Obtiene un objeto del pool seg�n el tipo especificado.
